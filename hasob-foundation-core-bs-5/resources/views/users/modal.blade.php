                    ...
                    <div class="row">
                        <div class="col-lg-12 ma-10">
                            ...
                            <div id="div-edit-txt-user-primary-id">
                                <div class="row">
                                    <div class="col-lg-12 ma-10">
                                        @include('hasob-foundation-core::users.fields')
                                    </div>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('click', ".btn-delete-mdl-user-modal", function(e) {
                ...
                swal({
                    ...
                    if (isConfirm) {
                        ...
                        let endPointUrl = "{{ route('fc.user.delete','') }}/"+itemId;
            ...
            $('#btn-save-mdl-user-modal').click(function(e) {
               ...
               // let endPointUrl = "{{ route('fc.user.store') }}";
                let primaryId = $('#txt-user-primary-id').val();
                const Id =  primaryId ?? null
                let endPointUrl = "{{ route('fc.user.store','') }}/"+Id;
                let formData = new FormData();
                formData.append('_token', $('input[name="_token"]').val());
                formData.append('id', primaryId);
                {{--if (primaryId != "0"){--}}
                {{--    actionType = "PUT";--}}
                {{--    endPointUrl = "{{ route('fc.user.update','') }}/"+primaryId;--}}
                {{--    formData.append('id', primaryId);--}}
                {{--}--}}
